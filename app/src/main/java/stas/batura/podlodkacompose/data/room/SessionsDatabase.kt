 ...
 * so you can reuse it.
 */
@Database(entities =[Session::class, Favourite::class], version = 1, exportSchema = false)
abstract class SessionsDatabase : RoomDatabase() {

    /**
     * Connects the database to the DAO.
     */
    abstract val sessionsDatabaseDao: SessionsDao
...
//                                .execute(Runnable { INSTANCE!!.radioDatabaseDao.insertRain(rain)})
                    }
